window.CAFFIEND_CONFIG = {
  ...
  seasons: {
    spring: {
      ...
      productLabel: "TODAY'S SEASONAL DESSERT",
      productName: "오늘의 봄 제철 디저트",
      productCopy: "매장에서 오늘 준비된 제철 메뉴를 확인해보세요.",
      shareTag: "CAFFIEND SPRING RISE",
      accent: "#a55363",
      accentSoft: "#ead4d9",
      surface: "#f6eee9",
      paper: "#fffaf7",
    ...
    summer: {
      ...
      productLabel: "TODAY'S SEASONAL DESSERT",
      productName: "오늘의 여름 제철 디저트",
      productCopy: "매장에서 오늘 준비된 제철 메뉴를 확인해보세요.",
      shareTag: "CAFFIEND SUMMER RISE",
      accent: "#d36b45",
      accentSoft: "#f2d2bf",
      surface: "#f7efe0",
      paper: "#fffbf3",
    ...
    autumn: {
      ...
      productLabel: "TODAY'S SEASONAL DESSERT",
      productName: "오늘의 가을 제철 디저트",
      productCopy: "매장에서 오늘 준비된 제철 메뉴를 확인해보세요.",
      shareTag: "CAFFIEND AUTUMN RISE",
      accent: "#9d5443",
      accentSoft: "#e4c7ba",
      surface: "#f2eadc",
      paper: "#fffaf1",
      ...
      brandLines: [
        "좋은 기다림에는 자신만의 리듬이 있습니다.",
        "한 번 더 할수록, 좋은 순간이 보입니다.",
        "오늘의 제철이 기다림의 끝을 완성합니다."
      ],
    ...
    winter: {
      ...
      productLabel: "TODAY'S SEASONAL DESSERT",
      productName: "오늘의 겨울 제철 디저트",
      productCopy: "매장에서 오늘 준비된 제철 메뉴를 확인해보세요.",
      shareTag: "CAFFIEND WINTER RISE",
      accent: "#7f4d54",
      accentSoft: "#dac9cd",
      surface: "#f1f1ed",
      paper: "#fbfbf7",
      ...
      brandLines: [
        "조금 더 기다리면, 더 좋은 순간이 옵니다.",
        "정확한 한 번이 오늘의 기록을 만듭니다.",
        "따뜻한 한입으로 기다림을 마무리합니다."
      ],
